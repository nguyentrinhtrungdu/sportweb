...
<body>
    ...
    <?php
        ...
        <div class="home-filter">
         ...
         <div class="home-filter__page">
             <span class="home-filter__page-num">
                 <span class="home-filter__page-current">2</span>/3
             </span>
             <div class="home-filter__page-control">
                 <a href="/allproduct.php" class="home-filter__page-btn ">
                     <i class="home-filter__page-icon fa-solid fa-chevron-left"></i>
                 </a>
                 <a href="/allproductpage3.php" class="home-filter__page-btn 
                 ">
     ...
     <div class="pagination-container">
        <ul class="pagination">
            <li><a href="allproduct.php">&laquo;</a></li>
            <li><a href="allproduct.php">1</a></li>
            <li class="active"><a href="#">2</a></li>
            <li><a href="allproductpage3.php">3</a></li>
            <li><a href="allproductpage3.php">&raquo;</a></li>
        </ul>
    </div>
